...
- AWS · VMware 기반 하이브리드 인프라 설계에 관심이 있습니다
- AIOps, 자동화를 통한 효율적인 시스템 운영을 지향합니다
- DevOps와 로우레벨 인프라 엔지니어 사이에서 방향을 탐색 중입니다
...
| `2026.03‑2026.04` | [**vSphere 가상화 인프라 구축**](https://github.com/ssh221/VMware-proj) | VMware 기반 가상화 인프라 설계 및 구축 |
...
| **ELK Stack**           | [**우리카드 소비 데이터 분석**](https://github.com/ssh221/ELK-project) |   
...
| :-------------------: | :------------------------ | :--------------------------------- |
| `2025.07 - 2025.12` | **메타엠**  | AICC 연구원 인턴                   |
...
| Period | Organization | Program |
| :---: | :--- | :--- |
| `2025.12-2026.06` | **우리FIS아카데미** | 금융 IT 클라우드 엔지니어링 교육생 |
...
- 이메일: [ssh221@naver.com](mailto:ssh221@naver.com)
